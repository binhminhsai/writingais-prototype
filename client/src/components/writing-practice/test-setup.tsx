      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div>
          ...
          >
            ...
            <SelectContent className="p-1">
              <SelectItem value="ielts-task2" className="text-base py-1.5">IELTS Writing Task 2</SelectItem>
              <SelectItem value="toefl" className="text-base py-1.5">TOEFL Independent Writing</SelectItem>
              <SelectItem value="general" className="text-base py-1.5">General Essay</SelectItem>
              <SelectItem value="business" className="text-base py-1.5">Business Writing</SelectItem>
            </SelectContent>
          </Select>
        </div>
        ...
        <div>
          ...
          >
            ...
            <SelectContent className="p-1">
              <SelectItem value="easy" className="text-base py-1.5">IELTS 5.0</SelectItem>
              <SelectItem value="medium" className="text-base py-1.5">IELTS 6.0</SelectItem>
              <SelectItem value="hard" className="text-base py-1.5">IELTS 7.0</SelectItem>
              <SelectItem value="expert" className="text-base py-1.5">IELTS 8.0</SelectItem>
            </SelectContent>
          </Select>
        </div>
      </div>
      ...
      <div className="mt-6 flex items-center justify-between">
        <div>
          ...
          >
            ...
            <SelectContent className="p-1">
              <SelectItem value="0" className="text-base py-1.5">No limit</SelectItem>
              <SelectItem value="20" className="text-base py-1.5">20 minutes</SelectItem>
              <SelectItem value="30" className="text-base py-1.5">30 minutes</SelectItem>
              <SelectItem value="40" className="text-base py-1.5">40 minutes</SelectItem>
              <SelectItem value="60" className="text-base py-1.5">60 minutes</SelectItem>
            </SelectContent>
          </Select>
        </div>
