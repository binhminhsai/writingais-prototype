    ...
    <div className="p-6">
      ...
      <div className="grid-container grid grid-cols-1 md:grid-cols-2 gap-4 mb-6 items-start">
        ...
        <div className="left-col flex flex-col gap-3">
            {/* Overall Band Score */}
            <div className="box border-2 border-gray-300 rounded-xl p-4" style={{ backgroundColor: "#bfc0c0" }}>
        ...
        <div className="right-col flex flex-col gap-3">
            ...
            {/* Writing Statistic */}
            <div className="stat-box border-2 border-gray-300 rounded-xl p-4 text-center mb-0" style={{ backgroundColor: "#bfc0c0" }}>
