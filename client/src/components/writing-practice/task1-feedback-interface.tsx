  ...
  return (
    <TooltipProvider>
      ...
      <div className="container grid grid-cols-1 md:grid-cols-2 gap-4 mb-6 max-w-[1100px] mx-auto">
        ...
        <div className="column flex flex-col gap-4">
            {/* Overall Feedback */}
            <div className="box border border-gray-200 rounded-lg p-4 h-auto bg-[#ffffff]">
      ...
      <div className="container max-w-[1100px] mx-auto mb-6">
        ...
        <div className="bg-white rounded-lg p-6 mb-4 border-2 border-cyan-300 shadow-sm">
          <div className="text-[#0c0a09] font-bold text-sm mb-3">IELTS Writing Task 1:</div>
