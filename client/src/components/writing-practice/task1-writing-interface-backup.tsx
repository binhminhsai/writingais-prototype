...
function Task1OutlineSection({ questionType, question }: { questionType: string, question: string }) {
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      {/* Always visible tabs - but content only shows when showTaskBreakdown is true */}
      <Tabs defaultValue="expressions" className="w-full h-full flex flex-col">
        ...
        {/* Tab Content - Only show if Task Breakdown is enabled */}
        {showTaskBreakdown && (
          <>
            <TabsContent 
              value="outline" 
            ...
            >
              <div>
                ...
                <div className="overflow-y-auto custom-scrollbar" style={{ maxHeight: '430px' }}>
                  <Accordion type="single" collapsible className="w-full space-y-2">
                    {/* Sample content accordions will be here */}
                    <AccordionItem 
                      value="paragraph-1"
                      className="border border-gray-200 rounded-lg overflow-hidden shadow-sm"
                    >
            ...
            >
              <div>
                ...
                <div className="overflow-y-auto custom-scrollbar" style={{ maxHeight: '430px' }}>
                  <Accordion type="single" collapsible className="w-full space-y-2">
                    {/* Analysis content accordions will be here */}
                    <AccordionItem 
                      value="image-description"
                      className="border border-gray-200 rounded-lg overflow-hidden shadow-sm"
                    >
                      ...
                      <AccordionContent className="p-3 bg-white">
                        {isLoading ? (
                          ...
                          <div className="space-y-3">
                            ...
                            <div className="p-3 rounded-md border border-blue-100 bg-[#f9fafb] text-[#374151]">
                              <p className="text-xs">
                                <span className="text-[#1fb2aa] font-bold">Main Subject:</span> Energy consumption analysis
                              </p>
                            </div>
                          </div>
                        )}
