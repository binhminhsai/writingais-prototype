...
export function ChemicalFlaskLoader({ isVisible, onComplete }: ChemicalFlaskLoaderProps) {
  ...
  return (
    <div className={`fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 transition-opacity duration-300 ${
      ...
      <div className={`bg-white rounded-lg p-8 flex flex-col items-center max-w-md w-full mx-4 transition-all duration-500 ${
        ...
        <div className="w-full bg-gray-200 rounded-full h-2 mt-4">
          <div 
            className="bg-[#1fb2aa] h-2 rounded-full transition-all duration-100 ease-out"
