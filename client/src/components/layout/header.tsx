      ...
      <div className="container mx-auto px-4 py-2 flex justify-between items-center">
        ...
        <nav className="hidden lg:flex items-center mr-6">
          <div className="flex items-center space-x-1 bg-teal-800/30 rounded-xl p-1 backdrop-blur-sm">
            ...
            <a 
              href="https://demo.wordpress.com" 
              target="_blank" 
              rel="noopener noreferrer"
              className="px-4 py-2 rounded-lg text-sm font-medium transition-all duration-300 text-teal-100 hover:text-white hover:bg-teal-600/50 flex items-center gap-1"
            >
              Blog
        ...
        <div className="lg:hidden bg-teal-800 px-4 py-3 shadow-inner text-sm border-t border-teal-600/50">
          <nav className="flex flex-col space-y-2">
            ...
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="w-full text-left py-2.5 px-3 rounded-lg transition-all duration-300 text-teal-100 hover:text-white hover:bg-teal-600/50 flex items-center gap-2"
              onClick={() => setMobileMenuOpen(false)}
            >
              Blog
              <svg xmlns="http://www.w3.org/2000/svg" className="h-3 w-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
